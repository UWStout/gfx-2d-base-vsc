// TODO: Copy over your matrix_math code from project 1
// NOTE: Double check that you did all of the following correctly
//   - You are using 'column-major' storage of your matrices everywhere
//   - Scaling ALWAYS happens around the shape center
//   - Rotation is around the origin UNLESS shape.rotAroundCenter is true
//   - ALL functions are exported (just put 'export' before the word 'function')
